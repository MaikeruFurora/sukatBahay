<nav class="navbar navbar-expand-lg {{  Request::segment(1)==''?'navbar-light':'navbar-light bg-light' }}">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 py-0 mb-lg-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown" style="font-size: 13px;color:black">
                        ...
                        <li class="nav-item dropdown drop-down02 ">
                            ...
                            <ul class="dropdown-menu sub-menu02" aria-labelledby="navbarDropdown" style="font-size: 12px">
                                @forelse ($item['sections'] as $sub)
                                    <li><a class="dropdown-item" href="{{ url('rule-sections/'.$item->slug.'/'.$sub->slug) }}">{{ $sub->section_title }}</a></li>
                                @empty
            ...
            <ul class="d-flex navbar-nav mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('auth.login') }}">Bookmark</a>
                </li>
                @endauth
            </ul>
            </ul>
